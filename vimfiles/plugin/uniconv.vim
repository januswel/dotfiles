...
" Last Change:  2009/12/18 16:23:26.
" Version:      0.10
" Dependency:
...
if !(exists('no_plugin_maps') && no_plugin_maps)
    ...
    if !hasmapto('<Plug>Convert2Utf8Literal')
        nmap <unique><Leader>ul
                    \ <Plug>Convert2Utf8Literal
    endif
    if !hasmapto('<Plug>Convert2Utf8Pattern')
        nmap <unique><Leader>up
                    \ <Plug>Convert2Utf8Pattern
    endif
endif

nnoremap <silent><Plug>Convert2Utf8Literal
            \ :silent call <SID>Convert2Utf8Literal()<CR>
nnoremap <silent><Plug>Convert2Utf8Pattern
            \ :silent call <SID>Convert2Utf8Pattern()<CR>

" functions {{{2
function! s:Convert2Utf8Literal()
    return s:ReplaceCword(function('unicode#GetLiteral'))
endfunction

function! s:Convert2Utf8Pattern()
